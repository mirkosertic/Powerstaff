...
public abstract class PersonEditorBackingBeanDataModel<T extends Person>
		extends NavigatingBackingBeanDataModel<T> {
	...
	public void setEntity(T entity) {
		...
		contacts = new CollectionDataModel<FreelancerContact>(getEntity()
				.getContacts());
	...
	public void setSearchResult(
			CollectionDataModel<GenericSearchResult> searchResult) {
