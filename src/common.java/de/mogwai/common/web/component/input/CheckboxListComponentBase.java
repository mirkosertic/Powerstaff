 ...
 * 11:38:15 CET 2007
 */
public abstract class CheckboxListComponentBase extends de.mogwai.common.web.component.input.BaseInputComponent {

    public static final String FAMILY_NAME = "MogwaiInputFamily";

    public static final String COMPONENT_TYPE = "CheckboxListComponent";

    public static final String RENDERER_TYPE = "CheckboxListRenderer";
