 ...
 * 11:38:15 CET 2007
 */
public abstract class DatepickerComponentBase extends de.mogwai.common.web.component.input.BaseInputComponent {

    public static final String FAMILY_NAME = "MogwaiInputFamily";

    public static final String COMPONENT_TYPE = "DatepickerComponent";

    public static final String RENDERER_TYPE = "DatepickerRenderer";
