 ...
 * 11:38:15 CET 2007
 */
public abstract class CheckboxComponentBase extends de.mogwai.common.web.component.input.LabeledComponent {

    public static final String FAMILY_NAME = "MogwaiInputFamily";

    public static final String COMPONENT_TYPE = "CheckboxComponent";

    public static final String RENDERER_TYPE = "CheckboxRenderer";
