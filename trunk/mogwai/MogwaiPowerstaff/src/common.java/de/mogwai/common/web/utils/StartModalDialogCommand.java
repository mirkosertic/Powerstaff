...
/**
 * Kommando zum Initialisieren eines Modalen Dialoges.
 * 
 * @author $Author: mirkosertic $
 * @version $Date: 2008-08-15 16:09:14 $
 */
public class StartModalDialogCommand extends UpdateModelCommand {
    ...
    public StartModalDialogCommand(BackingBean aInitiator, ModalPageDescriptor aDescriptor) {
        pageDescriptor = aDescriptor;
        initiator = aInitiator;
    }

    public ModalPageDescriptor getPageDescriptor() {
        return pageDescriptor;
    }

    public BackingBean getInitiator() {
        return initiator;
    }
}