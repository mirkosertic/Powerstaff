...
public enum SystemParameterEnum implements BaseEnumItemEnum {
    ...
    INDEXER_NETWORK_DIR(1L), INDEXER_PATH(2L), INDEXER_SOURCE_PATH(3L), NEWSLETTER_BATCH_COUNT(
            ...
            17L), WEBSYNC_ENABLED(18L), DELETEDDOCUMENT_REMOVAL(19L), INDEXING_ENABLED(
            20L), PROFILE_MAX_SEARCH_RESULT(21L), MAX_SEARCH_RESULT(27L), PDFFORMATENABLED(
